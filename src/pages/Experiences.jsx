...
const Experiences = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-[#0453f1] relative overflow-hidden py-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-20">
            ...
            <h1 className="text-6xl md:text-7xl font-bold text-white mb-8 animate-slide-up">Experiences</h1>
      ...
      <div className="py-16 bg-gradient-to-br from-neutral-50 to-primary-blue-50">

...
const Courses = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Upper section with the new solid blue background */}
      <div className="bg-[#0453f1] relative overflow-hidden py-24">
        {/* Background Pattern */}
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-20 left-20 w-72 h-72 bg-accent-yellow-400/10 rounded-full blur-3xl floating-animation"></div>
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-primary-blue-400/10 rounded-full blur-3xl floating-animation" style={{ animationDelay: '3s' }}></div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-semibold text-white mb-6 animate-fade-in">
              <div className="w-2 h-2 bg-accent-yellow-400 rounded-full mr-2 pulse-glow-yellow"></div>
              Course Database
            </div>
            <h1 className="text-6xl md:text-7xl font-bold text-white mb-8 animate-slide-up">Course Reviews</h1>

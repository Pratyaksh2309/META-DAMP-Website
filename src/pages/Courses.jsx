  ...
  return (
    <div className="py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        {/* Filters */}
        {showFilters && (
          <div className="flex flex-wrap gap-4 mb-16 justify-center animate-fade-in transition-all duration-300" style={{animationDelay: '0.6s'}}>
          ...
          <SearchBar filter="courses" onSearchToggle={setShowFilters} />
        </div>

    ...
    return (
        <div>
            {/* Hero Section with Floating Images */}
                <section className="relative min-h-screen flex items-center justify-center pt-20 pb-32 px-6 overflow-hidden modern-hero-bg bg-[#0453f1]">
                ...
                >
                    ...
                    <div className="flex flex-col justify-between gap-4">
                        ...
                        >
                            <div className="floating-image w-32 h-40 bg-white/20"></div>
                        </motion.div>
                        <motion.div
                            whileHover={{ scale: 1.05, rotate: -2 }}
                            transition={{ duration: 0.3 }}
                        >
                            <div className="floating-image w-32 h-40 bg-accent/25"></div>
                        </motion.div>
                        <motion.div
                            whileHover={{ scale: 1.05, rotate: 2 }}
                            transition={{ duration: 0.3 }}
                        >
                            <div className="floating-image w-32 h-40 bg-white/25"></div>
                        </motion.div>
                    </div>
                    ...
                    <div className="flex flex-col justify-center gap-10">
                        <motion.div
                            ...
                            transition={{ duration: 0.3 }}
                        >
                            <div className="floating-image w-28 h-36 bg-white/15"></div>
                        </motion.div>
                        <motion.div
                            whileHover={{ scale: 1.08, rotate: 2 }}
                            transition={{ duration: 0.3 }}
                        >
                            <div className="floating-image w-28 h-36 bg-accent/20"></div>
                        </motion.div>
                    </div>
                    ...
                    <div className="flex flex-col justify-center">
                        <motion.div
                            ...
                            transition={{ duration: 0.3 }}
                        >
                            <div className="floating-image w-24 h-32 bg-white/15"></div>
                        </motion.div>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    animate={{ x: 0, opacity: 1 }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                    className="absolute right-8 top-1/5 -translate-y-1/5 hidden lg:grid grid-cols-3 gap-3 h-[80vh]"
                >
                    ...
                    <div className="flex flex-col justify-center gap-10">
                        <motion.div
                            ...
                            transition={{ duration: 0.3 }}
                        >
                            <div className="floating-image w-28 h-36 bg-accent/25"></div>
                        </motion.div>
                        <motion.div
                            whileHover={{ scale: 1.08, rotate: -2 }}
                            transition={{ duration: 0.3 }}

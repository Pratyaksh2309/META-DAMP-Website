      ...
      <div className="px-10 py-2 border-t border-primary-blue-200/30">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mt-6 md:mt-0">
              ...
              <a href="#" className="w-10 h-10 bg-accent-yellow-100 hover:bg-accent-yellow-200 rounded-xl flex items-center justify-center text-accent-yellow-600 hover:text-accent-yellow-700 transition-all duration-300 hover:scale-110">
